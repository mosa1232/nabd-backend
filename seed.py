...
def _seed(db: Session) -> None:
    ...
    # --- clinical pearls -------------------------------------------------
    # Demo content for the landing page and the "لمحات سريرية" screen, in
    # the same spirit as the sample MCQ above. On a real deployment these
    # come from an admin writing them in the dashboard.
    pearls = [
        ("طوارئ", "مريض يعاني من ضيق تنفس مفاجئ بعد رحلة طويلة",
         "ضيق تنفس مفاجئ بعد سفر طويل وجلوس ممتد يرفع احتمال الانصمام الرئوي. "
         "ابحث عن تسرّع النبض، ألم صدر جنبي، وانخفاض تشبّع الأوكسجين. "
         "التقييم يبدأ بمقياس Wells ثم التصوير المقطعي الوعائي عند الحاجة، "
         "والبدء بمضاد التخثر لا يُؤجَّل عند الاشتباه العالي وثبات المريض."),
        ("تشخيص", "ألم صدر يمتد لليد اليسرى عند رجل بعمر الخمسين",
         "ألم ضاغط خلف القص يمتد للذراع اليسرى أو الفك مع تعرّق وغثيان يوجّه "
         "نحو متلازمة الشريان التاجي الحادة. تخطيط القلب خلال أول عشر دقائق "
         "هو ما يفرّق بين احتشاء برفع ST وغيره، ويحدد إن كان المريض يحتاج "
         "قسطرة عاجلة أم علاجاً دوائياً ومتابعة الإنزيمات."),
        ("أطفال", "طفل بحمى مستمرة ثلاثة أيام مع طفح جلدي منتشر",
         "الحمى المستمرة مع طفح عند طفل تستدعي التفريق بين الأسباب الفيروسية "
         "الشائعة وبين ما لا يُفوَّت: التهاب السحايا بالمكورات السحائية، وداء "
         "كاوازاكي. راقب تغيّرات الشفاه واللسان، احمرار الملتحمة، وتورّم "
         "الأطراف — تأخير تشخيص كاوازاكي يعرّض الشرايين التاجية للتمدد."),
    ]
    for tag, title, text in pearls:
        db.add(models.ClinicalPearl(tag=tag, title=title, body=text))
